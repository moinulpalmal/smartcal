...
@section('content')
    ...
    <div class="page page-profile">
        ...
        <h2>Fabric <span> Booking Details</span></h2>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{route('fabric.booking.recent')}}"> Recent Bookings</a>
                </li>
                <li>
                    <a href="{{route('fabric.booking.detail', ['id', $purchaseOrder->id ])}}"> LPD PO NO: {{$purchaseOrder->lpd_po_no}}</a>
                </li>
            </ul>
        </div>
    </div>
                                                                    ...
                                                                    <div class="tile-body">
                                                                        ...
                                                                        <div class="row" style="padding: 0px 15px;">
                                                                            <div class="col-md-8 no-padding">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select id="ProductID" class="form-control select2" name="fabric_product_setup" required style="width: 100%;">
                                                                        ...
                                                                        <div class="row" style="padding: 0px 15px;">
                                                                            <div class="col-md-5 no-padding">
                                                                                <div class="form-group">
                                                                                    <label for="Size" class="control-label">Construction</label>
                                                                                    <input type="text" class="form-control" name="construction" id="Size" required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-5 no-padding">
                                                                                <div class="form-group">
                                                                                    <label for="Color" class="control-label">Width</label>
                                                                                    <input type="text" class="form-control" name="width" id="Color" required>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table table-hover table-bordered table-condensed table-responsive" id="advanced-usage{{$uproduct->id}}">
                                                                    ...
                                                                    <tr style="background-color: #1693A5; color: white;">
                                                                        <th class="text-center">Construction</th>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        @foreach($details as $item)
                                                                            @if($item->fabric_product_setup_id == $uproduct->id)
                                                                                <tr>
                                                                                    <td class="text-left">{{$item->construction}}</td>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        ...
                                                                                        @if(Auth::user()->hasTaskPermission('updatefitem', Auth::user()->id))
...
@section('pageScripts')
    <script>
        ...
        $('#advanced-usage{{$uproduct->id}}').on('click',".DeleteDetail", function(){
            ...
            var url = '{{ route('fabric.booking.detail.delete') }}';
            swal({
                title: 'Are you sure?',
        ...
        $('#purchase-order').on('click',".UrgentOrder", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('fabric.booking.urgent') }}';
            swal({
                title: 'Are you sure?',
        ...
        $('#purchase-order').on('click',".ReviseOrder", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('fabric.booking.revise') }}';
            swal({
                title: 'Are you sure?',
        ...
        $('#purchase-order').on('click',".DeleteOrder", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('fabric.booking.delete') }}';
            swal({
                title: 'Are you sure?',
        ...
        $(function(){
            ...
            $('#ItemAdd').submit(function(e){
                ...
                //return;
                var url = '{{ route('fabric.booking.detail.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
